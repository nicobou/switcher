...
VideoCodec::VideoCodec(quiddity::Quiddity* quid,
    ...
    : quid_(quid),
      ...
      param_group_id_(quid_->pmanage<&quiddity::property::PBag::make_group>(
          "codec_params", "Codec configuration", "Codec specific parameters")) {
  set_shm(shmpath);
  reset_codec_configuration();
  quid_->pmanage<&quiddity::property::PBag::set_to_current>(codec_id_);
}
...
void VideoCodec::show() {
  ...
  quid_->pmanage<&quiddity::property::PBag::enable>(param_group_id_);
}
...
bool VideoCodec::reset_codec_configuration() {
  ...
  quid->pmanage<&quiddity::property::PBag::notify>(codec_id_);
  make_codec_properties();
  quid->pmanage<&quiddity::property::PBag::set_str>(
      quid->pmanage<&quiddity::property::PBag::get_id>("bitrate"), "4096");
  quid->pmanage<&quiddity::property::PBag::set_str>(
      quid->pmanage<&quiddity::property::PBag::get_id>("pass"), "cbr");
  return true;
}
...
bool VideoCodec::start() {
  hide();
  if (0 == quid_
               ->pmanage<&quiddity::property::PBag::get<quiddity::property::IndexOrName>>(
                   codec_id_)
               .index_)
    return true;
...
void VideoCodec::set_none() {
  quid_->pmanage<&quiddity::property::PBag::set<quiddity::property::IndexOrName>>(
      quid_->pmanage<&quiddity::property::PBag::get_id>("codec"), 0);
}
